...
void *threadCommunication(void *arg){
     ...
     //pidSignals l_sDataToSend;
     commandsLl l_sDataToSend;
     ...
     while(1){
		...
		l_sDataToSend.COM_2 = -0.2;
		l_sDataToSend.COM_0 = 1.33;
		l_sDataToSend.COM_1 = 0.888;
		l_sDataToSend.COM_3 = -2.3;
		...
		*/
		...
		std::cout << "MX: " << l_RxFrame.MX << std::endl;
		std::cout << "MY: " << l_RxFrame.MY << std::endl;
		std::cout << "MZ: " << l_RxFrame.MZ << std::endl;
		...
		//!********Send Auto Commands********!//
		//int *l_piPpmSend = c->uartComTx(0, 170, 1810, 90, l_bStop, l_bStatus, l_sDataToSend); //aggiunto il controllo di consistenza sui dati
		//!************************************//
